...
module ScarpeTuiBackend
  ...
  ffi_lib ENV.fetch("SCARPE_TUI_LIB", File.expand_path("../rust_core/target/release/librust_core.dylib", __dir__))
  ...
  attach_function :scarpe_tui_set_checkbox_state, [:pointer, :int, :bool], :int
